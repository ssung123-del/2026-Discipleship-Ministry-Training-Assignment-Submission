...
export const TRAINING_WEEKS: WeekOption[] = [
  ...
  { id: 'week-7', label: '7주차 (10/25 주일)', topic: '7과 재림과 신앙생활', assignmentItems: ['성경읽기: 살전, 살후, 딤전, 딤후', 'D형큐티: 마 25:1-13', '암송: 눅 21:36', '암송시험 및 기말고사'], section: '리더십 & 교리 코칭', startDate: '2026-10-25' },

  // 다니엘 프로젝트
  { id: 'week-8', label: '8주차 (11/1 주일)', topic: '8과 다니엘 프로젝트 PART 1. 뜻을 정함', assignmentItems: ['성경읽기: 딛, 몬, 히', '과제: 다니엘기도회 요약', '암송: 빌 2:1-11', '다니엘 프로젝트 1권'], section: '다니엘 프로젝트', startDate: '2026-11-01' },
